...
-- Set working directory to the file or directory opened with nvim
      ...
      config = function()
        ...
        local servers = {
          ...
          ruff = {
            init_options = {
              settings = {
                configurationPreference = 'filesystemFirst', -- prefer pyproject.toml / ruff.toml
                fixAll = true, -- enable "source.fixAll" code action
                organizeImports = true, -- enable "source.organizeImports" code action
                logLevel = 'warn',
                -- lineLength = 100,      -- (optional) editor override; prefer pyproject.toml instead
              },
            },
          },
          mesonlsp = {},
